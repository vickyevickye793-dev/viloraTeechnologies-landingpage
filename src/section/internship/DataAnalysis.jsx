      ...
      <section className="relative py-20 text-center">
        ...
        <div className="relative z-10">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-500 leading-relaxed mb-10">
            Master Excel, SQL, Python and BI tools with hands-on live datasets.
            Build dashboards and become industry-ready with real-world experience.
          </p>
        ...
        <div className="flex items-start gap-6 bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              Learn how to collect, clean, analyze and visualize data using
              Excel, SQL, Python and BI tools. Work on real-world datasets and
              build professional dashboards used in business environments.
            </p>
          </div>
        </div>
      </section>

      {/* SKILLS + OUTCOMES SAME SPACING */}
